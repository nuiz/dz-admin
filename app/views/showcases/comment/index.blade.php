...
<div style="width: 660px; margin: 0 auto; padding: 10px 0; background: white;">
    <div class="news-block display-block">
        <div>
            <iframe class="youtube-player" type="text/html" width="640" height="385" src="http://www.youtube.com/embed/<?php echo $showcase->youtube_id;?>" allowfullscreen frameborder="0">
            </iframe>
        </div>
        <p>
            <?php echo nl2br($showcase->description);?>
        </p>
    </div>
